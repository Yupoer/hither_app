...
const zh = {
  ...
  'solo.badge': 'Solo 中',
  'subgroup.split': '分組',
  'subgroup.selectHint': '點選要拆出的成員（至少 2 人）',
  'subgroup.create': '建立小隊（{count}）',
  'subgroup.needTwo': '小隊至少需要 2 人',
  'subgroup.remainOne': '拆出後只剩 1 人，小隊至少要 2 人',
  'subgroup.selectFewer': '不能把整個小隊都拆出去',
  'subgroup.modeTitle': '小隊模式',
  'subgroup.modeMsg': '要指定小隊隊長，還是協作制、不分隊長？',
  'subgroup.modeLed': '隊長制（第一位選取者帶隊）',
  'subgroup.modeCollab': '協作制',
  'subgroup.defaultName': '小隊 {index}',
  'subgroup.led': '隊長：{name}',
  'subgroup.collab': '協作',
  'subgroup.childOf': '隸屬{name}',
  'subgroup.merge': '併回',
  'subgroup.mergeChildrenFirst': '請先併回它底下的小隊',
  'subgroup.failed': '分組操作失敗',
  'subgroup.selfSplitAction': '自行拆隊',
  'subgroup.selfSplitName': '{name} 的小隊',
  'subgroup.selfMergeAction': '合併回大隊',
  'subgroup.you': '你',
  'map.loading': '載入群組位置中…',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'solo.badge': 'Solo',
  'subgroup.split': 'Split',
  'subgroup.selectHint': 'Pick the members to split off (at least 2)',
  'subgroup.create': 'Create team ({count})',
  'subgroup.needTwo': 'A team needs at least 2 members',
  'subgroup.remainOne': 'That would leave 1 behind — teams need at least 2',
  'subgroup.selectFewer': "You can't split off the whole team",
  'subgroup.modeTitle': 'Team mode',
  'subgroup.modeMsg': 'Appoint a team leader, or collaborate with no leader?',
  'subgroup.modeLed': 'Led (first pick leads)',
  'subgroup.modeCollab': 'Collaborative',
  'subgroup.defaultName': 'Team {index}',
  'subgroup.led': 'Leader: {name}',
  'subgroup.collab': 'Collaborative',
  'subgroup.childOf': 'under {name}',
  'subgroup.merge': 'Merge back',
  'subgroup.mergeChildrenFirst': 'Merge its nested teams back first',
  'subgroup.failed': 'Subgroup action failed',
  'subgroup.selfSplitAction': 'Split off',
  'subgroup.selfSplitName': "{name}'s team",
  'subgroup.selfMergeAction': 'Merge back',
  'subgroup.you': 'You',
