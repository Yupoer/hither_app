...
const zh = {
  ...
  'settings.passiveCompanionMode': '被動同行者模式',
  ...
  'paywall.freePlanHint': '最多 {members} 人（含隊長）、每個行程 {points} 個集合點',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'settings.passiveCompanionMode': 'Passive companion mode',
  'settings.passiveCompanionModeHint':
  ...
  'paywall.freePlanHint': 'Up to {members} people (including leader), {points} gathering points per itinerary',
