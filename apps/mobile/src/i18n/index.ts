...
const zh = {
  ...
  'settings.edit': '編輯',
  'settings.save': '儲存',
  'settings.nicknameEmpty': '暱稱不能為空。',
  'settings.nicknameFailed': '無法更新暱稱，請再試一次。',
  'settings.destinationsSection': '集合點',
  'settings.dragHint': '按住項目上下拖曳調整順序，向左滑動可刪除',
  ...
  'map.loading': '載入群組位置中…',
  'map.nextLabel': '下一集合點',
  'map.noDestinationLeader': '尚未設定集合點 · 點右上搜尋鈕新增',
  ...
  // Map · journey (start/pause) + banner
  'map.start': '開始',
  'map.pause': '暫停',
  'map.startA11y': '開始前往集合點',
  'map.pauseA11y': '暫停前往集合點',
  'map.journeyFailed': '無法更新行程狀態，請確認你是隊長並再試一次。',
  'map.bannerGoing': '前往集合點中',
  'map.bannerPaused': '已暫停',
  // Map · navigation flow (start / cancel / arrival)
  'map.navStart': '前往此集合點',
  'map.navStartA11y': '開始前往選取的集合點',
  'map.navCancel': '結束',
  'map.arrivedTitle': '已抵達 🎉',
  'map.arrivedBody': '你已抵達「{title}」，導航結束。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'settings.edit': 'Edit',
  'settings.save': 'Save',
  'settings.nicknameEmpty': 'Nickname cannot be empty.',
  'settings.nicknameFailed': "Couldn't update nickname, please try again.",
  'settings.destinationsSection': 'Gathering points',
  'settings.dragHint': 'Drag up or down to reorder; swipe left to delete',
  ...
  'map.noDestinationLeader': 'No gathering point yet · tap search top-right',
  ...
  'map.start': 'Start',
  'map.pause': 'Pause',
  'map.startA11y': 'Start heading to the gathering point',
  'map.pauseA11y': 'Pause heading to the gathering point',
  'map.journeyFailed': "Couldn't update journey status. Make sure you're the leader and try again.",
  'map.bannerGoing': 'Heading to gathering point',
  'map.bannerPaused': 'Paused',
  'map.navStart': 'Navigate here',
  'map.navStartA11y': 'Start heading to the selected gathering point',
  'map.navCancel': 'End',
  'map.arrivedTitle': 'Arrived 🎉',
  'map.arrivedBody': "You've reached “{title}”. Navigation ended.",
  ...
  'settings.notifHint': 'Each category can be toggled independently.',
