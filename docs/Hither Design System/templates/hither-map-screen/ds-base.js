...
(() => {
  const base = '../..';
  for (const p of ["tokens/fonts.css","tokens/colors.css","tokens/typography.css","tokens/spacing.css","tokens/radius.css","tokens/glass.css","tokens/shadows.css","tokens/motion.css","styles.css"]) {
